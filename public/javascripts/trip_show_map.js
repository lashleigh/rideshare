...
function calcRoute() {  
  var request = {
    ...
    waypoints: trip.google_options.waypoints.map(function(wpt) {return {location: new google.maps.LatLng(wpt[0], wpt[1]), stopover: false};}),
    travelMode: google.maps.TravelMode[selectedMode],
    unitSystem: google.maps.UnitSystem[unit_system],
    avoidHighways: trip.google_options.avoid_highways, 
    avoidTolls: trip.google_options.avoid_tolls
  };
